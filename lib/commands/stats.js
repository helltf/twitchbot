...
module.exports={
    ...
    required_parameters:"stats to check for",
...
const events = {
    cookie : async (lookupUser)=>{
        ...
        return `You claimed your last cookie ${hb.util.shortenTime(Date.now()-stats[0].TIME)} ago. Average recieved cookies ${average}. Cookie resets bought ${resets}` 
    }
}