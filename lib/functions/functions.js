 ...
 */
 module.exports.setPermissions=async (user,permissionlvl) =>{
 ...
 */
 module.exports.storeColor=async(twitch_id,color)=>{
    ...
    let colorHistoryArray = JSON.parse(colorresponse[0].COLOR_HIST)
        ...
        if(colorHistoryArray.length<10){
          ...
          if(!colorHistoryArray.includes(color)){
            ...
            let index = colorHistoryArray.indexOf(color)
        ...
        console.log(JSON.stringify(colorHistoryArray))
